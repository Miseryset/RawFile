...
echo "模块模板地址：$font_module "
echo "模板模块名称：$font_module_name "
echo ""
...
${START_DIR}/scripts/download_from_github.sh "$font_module" "FontTemplateS" "$font_module_name"

font_module="/sdcard/Download/${font_module_name}"
